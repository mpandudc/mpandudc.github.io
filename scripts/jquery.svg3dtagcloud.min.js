  ...
  function t(t, e) {
    function o() {
      (F = document.createElementNS(N, 'svg')),
        ...
        t.appendChild(F),
        x.bgDraw && ((D = document.createElementNS(N, 'rect')), D.setAttribute('x', 0), D.setAttribute('y', 0), D.setAttribute('fill', x.bgColor), F.appendChild(D)),
        a(),
        i(),
        h(),
    ...
    function i() {
      var e = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth,
        ...
        i = e,
        r = o;
      x.width.toString().indexOf('%') > 0 || x.height.toString().indexOf('%') > 0
        ? ((i = Math.round((t.offsetWidth / 100) * parseInt(x.width))), (r = Math.round((i / 100) * parseInt(x.height))))
    ...
    function s(t, e, o, i, n) {
      ...
      return (
        ...
        'undefined' != typeof e.tooltip ? ((r.tooltip = !0), (r.tooltipLabel = x.tooltipFontToUpperCase ? e.tooltip.toUpperCase() : e.tooltip)) : (r.tooltip = !1),
        (r.index = t),
        (r.mouseOver = !1),
    ...
    function f(t) {
      t.tooltip &&
        (w.setAttribute('x', t.vector2D.x - x.tooltipDiffX), w.setAttribute('y', t.vector2D.y - x.tooltipDiffY), (w.textContent = x.tooltipFontToUpperCase ? t.tooltipLabel.toUpperCase() : t.tooltipLabel), w.setAttribute('opacity', 1));
    }
    function d(t) {
    ...
    function p() {
      ...
      for (var n = 0, r = z.length; r > n; n++) {
        ...
        var c;
        M
          ? ((c = (C - s.vectorPosition.z) / S), c < x.opacityOut && (c = x.opacityOut))
          : ((c = parseFloat(s.element.getAttribute('opacity'))), (c += s.mouseOver ? (x.opacityOver - c) / x.opacitySpeed : (x.opacityOut - c) / x.opacitySpeed)),
    ...
    if (void 0 !== e) for (var A in e) e.hasOwnProperty(A) && x.hasOwnProperty(A) && (x[A] = e[A]);
